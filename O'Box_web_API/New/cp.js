			     ...
			     //  alert(node.values[j].toSource());
                            ...
                            if (node.values[j].type == 'list') {
                                ...
                                if (val == 'False')
                                    ...
                                    val = 'on';
                                if(node.values[6].cclass == "SENSOR ALARM")
                                {
                                    if(node.values[6].label == "Flood")
                                    {
                                     if(node.values[6].value == "255"){
                                      val = 'on';
                                     }
                                    else
                                    { val = 'off'; }
                                ...
                                if(node.values[2].cclass == "ALARM" || node.values[3].cclass == "ALARM")
                                {
                                    ...
                                    {
				      if(node.values[2].value == "0" && node.values[3].value == "0"){break;}
